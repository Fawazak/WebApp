...
},
{
    ...
    "imageSrc": require("../assets/digits.png"),
    "vidSrc": require("../assets/digits.mov"),
    "description": "Using Artificial Intelligence and Machine Learning to observe the accuracy of using Support Vector Machines against the MNIST data.",
    "skills":[ "Python", "AI"],
    "demo": "",
    "source": "https://github.com/Fawazak/fawazak.github.io/blob/main/ELEC_A2%20(2)%20(1).ipynb"
}];
